...
print("\nI starten var stemninga god. Gruppen opplevde høy motivasjon og fellesskap i målet om å lage en portal som kunne øke innbyggerengasjement og transparens i kommunen. " \
    "Men nå, etter seks uker, har prosjektet gått inn i den klassiske storming-fasen, der ulike faglige perspektiver og personlige preferanser begynner å kollidere."  )

print("\nSom prosjektleder må du navigere gjennom disse utfordringene for å sikre at prosjektet fortsetter.") 
